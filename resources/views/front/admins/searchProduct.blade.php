        ...
        <div class="navbar-nav-right  align-items-center" id="navbar-collapse">
            ...
            <form action="{{ route('searchProduct') }}" method="get">
                <div class="nav-item d-flex align-items-center" style="width: 100%;">
                    ...
                    <input value="{{request('key')}}" type="text" name="key" class="form-control border-0 shadow-none"
                           id="search_product"
                           placeholder="Search..."
                ...
                <div class="table-responsive text-nowrap content1">
                    <table class="table">
                        ...
                        @if ($search || is_array($search))
                                ...
                                $coun = ($currentPage - 1) * $search->perPage() + 1;
                                ?>
                            @foreach($search as $item )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('edit_product',encrypt($item->id))}}"
                                           class="btn btn-outline-info"><i
                                                class="bx bx-edit-alt me-1"></i>Edit</a><br><br>

                                        <form id="delete-form" action="{{ route('delete.product', $item->id) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Xoa San
                                                                Pham</h5>
