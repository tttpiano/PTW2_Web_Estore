    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header" style="background-color: #696cff; border-color: #696cff; color:#fff">
                HỆ ĐIỀU HÀNH</h5>
            <div class="add">
                <a class="btn btn-success" href="{{route("add_openratingSystems")}}"">Add</a>
            </div>
            <div class=" table-responsive text-nowrap content1">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            <?php
                            $currentPage = $openratingSystems->currentPage();
                            $coun = ($currentPage - 1) * $openratingSystems->perPage() + 1;
                            ?>
                            @foreach($openratingSystems as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("edit_openratingSystems",$item->id)}}"" class=" btn btn-outline-info"><i class="bx bx-edit-alt me-1"></i>Edit</a><br><br>
                                    <form id="delete-form" action="{{route('delete.openratingSystems', $item->id) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
                                        <!-- note  -->
        ...
        {!! $openratingSystems->links('pagination::bootstrap-5',) !!}
