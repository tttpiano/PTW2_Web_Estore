    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header" style="background-color: #696cff; border-color: #696cff; color:#fff">
                Voucher</h5>
            <div class="add">
            <a href="{{ route('add_voucher') }}" class="btn btn-success">Add</a>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0 ">
                        ...
                        <?php
                            ...
                            $coun = ($currentPage - 1) * $voucher->perPage() + 1;
                            ?>
                        ...
                        <tr>
                            ...
                            <td>{{$item->giam_voucher}}%</td>



                            <td>
                                <a href="{{ route('edit_voucher', $item->id) }}" class=" btn btn-outline-info"><i
                                        class="bx bx-edit-alt me-1"></i>Edit</a><br><br>

                                <form id="delete-form" method="POST" action="{{ route('delete.voucher', $item->id) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Bạn có muốn xoá <strong><b>{{$item->ten_voucher}}</b></strong>
                                                    này?
                                                </div>
