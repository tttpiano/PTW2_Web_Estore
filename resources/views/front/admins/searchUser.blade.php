...
<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <form action="{{ route('searchUser') }}" method="get">
        <div class="nav-item d-flex align-items-center" style="width: 100%;">
            ...
            <input type="text" value="{{ request('key') }}" name="key" class="form-control border-0 shadow-none" id="key" placeholder="Search..."
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td> <img style="width: 100px;" src="{{ asset('storage/img/'.$item->avatar)}}" alt="Image">
                            </td>
