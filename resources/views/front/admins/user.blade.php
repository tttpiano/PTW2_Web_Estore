                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td> <img style="width: 100px;" src="{{ asset('storage/img/'.$item->avatar)}}" alt="Image"></td>
                            ...
                            <td>
                                <a href="{{route('edit_user',$item->id)}}" class="btn btn-outline-info"><i class="bx bx-edit-alt me-1"></i>Edit</a><br><br>


                                <form id="delete-form" action="{{ route('delete.user', $item->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
